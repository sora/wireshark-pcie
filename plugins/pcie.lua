...
function pcie_proto.dissector(buffer, pinfo, tree)
	...
	tlp_subtree:add(f.tlp_fmt,     buffer( 6,1):bitfield(1, 2))
	tlp_subtree:add(f.tlp_type,    buffer( 6,1):bitfield(3, 5))
	tlp_subtree:add(f.tlp_rsvd1,   buffer( 7,1):bitfield(0, 1))
	tlp_subtree:add(f.tlp_tclass,  buffer( 7,1):bitfield(1, 3))
	tlp_subtree:add(f.tlp_rsvd2,   buffer( 7,1):bitfield(4, 4))
	tlp_subtree:add(f.tlp_digest,  buffer( 8,1):bitfield(0, 1))
	tlp_subtree:add(f.tlp_poison,  buffer( 8,1):bitfield(1, 1))
	tlp_subtree:add(f.tlp_attr,    buffer( 8,1):bitfield(2, 2))
	tlp_subtree:add(f.tlp_rsvd3,   buffer( 8,1):bitfield(4, 2))
	tlp_subtree:add(f.tlp_length,  buffer( 8,2):bitfield(6,10))
	...
	tlp_subtree:add(f.tlp_firstbe, buffer(13,1):bitfield(4, 4))
	tlp_subtree:add(f.tlp_addr,    buffer(14,4):bitfield(0,30))
	tlp_subtree:add(f.tlp_rsvd4,   buffer(17,1):bitfield(6, 2))
